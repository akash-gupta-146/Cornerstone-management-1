...
var ComplaintService = (function () {
    ...
    ComplaintService.prototype.postComplaintComment = function (complaintId, comment) {
        console.log("1", this.baseUrl);
        return this.http.post(this.baseUrl + "/complaint/" + complaintId + "/comment", comment)
            .map(this.extractData)
            .catch(this.handleError);
    };
    ComplaintService.prototype.updateComplaint = function (complaintId, complaint) {
        return this.http.put(this.baseUrl + "/complaint/" + complaintId, complaint)
            .map(this.extractData)
            .catch(this.handleError);
    };
    ComplaintService.prototype.closeComplaint = function (complaintId, complaint) {
